...
data_.add_title(plot_index=2,title_name='(2e) Second Excited State Energy ',fontsize=20)
...
data_.simple_scatter(plot_index=4,x_arry=J01,y_arry=J11,color_t=ex_with_J_3e[:,1],marker='s',log_scale_x=False,log_scale_y=False,label_name=' ',twinx=False,alpha=1,add_line=False,s=30,cbar_label='Energy')

data_.save_fig('/images',200,file_loc+'bare_')
data_.close_fig()