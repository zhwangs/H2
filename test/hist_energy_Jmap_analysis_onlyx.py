...
data_.simple_scatter(plot_index=1,x_arry=J01,y_arry=V00,color_t=ex_without_J_2e[:,0]-ex_with_J_2e[:,0],marker='s',log_scale_x=False,log_scale_y=False,label_name=' ',twinx=False,alpha=1,add_line=False,s=30,cbar_label='Energy')
data_.simple_scatter(plot_index=2,x_arry=J01,y_arry=V00,color_t=(ex_without_J_2e[:,1]-ex_without_J_2e[:,0])-(ex_with_J_2e[:,1]-ex_with_J_2e[:,0]),marker='s',log_scale_x=False,log_scale_y=False,label_name=' ',twinx=False,alpha=1,add_line=False,s=30,cbar_label='Energy')
data_.simple_scatter(plot_index=3,x_arry=J01,y_arry=V00,color_t=ex_without_J_3e[:,0]-ex_with_J_3e[:,0],marker='s',log_scale_x=False,log_scale_y=False,label_name=' ',twinx=False,alpha=1,add_line=False,s=30,cbar_label='Energy')
data_.simple_scatter(plot_index=4,x_arry=J01,y_arry=V00,color_t= (ex_without_J_3e[:,0]-ex_with_J_3e[:,0])-((ex_without_J_2e[:,1]-ex_without_J_2e[:,0])-(ex_with_J_2e[:,1]-ex_with_J_2e[:,0])),marker='s',log_scale_x=False,log_scale_y=False,label_name=' ',twinx=False,alpha=1,add_line=False,s=30,cbar_label='Energy')
